...
class Factory {
    ...
    static massBuild(car, quantity, color, trim, model) {
        car.quantity = quantity;
        car.color = color;
        car.trim = trim;
        car.model = model;
        console.log("Building " + car.quantity + " " + car.color + " " + car.trim + " " + car.model + "'s");
    }

    static customerBuild(car, quantity, color, trim, model, options) {
        car.quantity = quantity;
        car.color = color;
        car.trim = trim;
        car.model = model;
        car.options = options;
        console.log("Building " + car.quantity + " " + car.color + " " + car.trim + " " + car.model + " with the following options: " + car.options);
    };
}
...
console.log(Factory.massBuild(car, 35000, "Red", "Touring", "Mazda3"));
...
console.log(Factory.customerBuild(car, 1, "Yellow", "Touring", "mazda3", ["weather pacakge", " satellite radio", " rear spoiler"]));
...
console.log(Factory.massBuild(miataRf, 15000, "Red", "Grand Touring", "Miata-RF"));
...
console.log(Factory.customerBuild(miataRf, 1, "Black", "Grand Touring", "Miata-RF", ["hidden headlights", " sports suspension", " leather steering wheel", " heated seats", " adative cruise control"]));
...
console.log(Factory.massBuild(trailBlazer, 35000, "Blue", "Sport", "Trail Blazer"));
...
console.log(Factory.customerBuild(trailBlazer, 1, "Red", "Exploding", "Trail Blazer", ["seat warmers", " tinted windows", " fog lamps"]));
